...
void bill_show(int arID[],int arqty[],int counter)
{
    ...
    char items[10][16]={"Burger","Hot Dog","Donuts","French Fries","Chicken Nuggets","Chicken Wings","Ice Cream","Sweets","Coca-Cola","Mirinda"};
